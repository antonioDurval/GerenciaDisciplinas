...
class TurmasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create turma" do
    assert_difference('Turma.count') do
      post turmas_url, params: { turma: { ano: @turma.ano, ano_letivo: @turma.ano_letivo, letra: @turma.letra } }
    end
  ...
  test "should update turma" do
    patch turma_url(@turma), params: { turma: { ano: @turma.ano, ano_letivo: @turma.ano_letivo, letra: @turma.letra } }
