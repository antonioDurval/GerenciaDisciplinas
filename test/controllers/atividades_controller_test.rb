...
class AtividadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create atividade" do
    assert_difference('Atividade.count') do
      post atividades_url, params: { atividade: { bimestre: @atividade.bimestre, data: @atividade.data, descricao: @atividade.descricao, titulo: @atividade.titulo } }
    end
  ...
  test "should update atividade" do
    patch atividade_url(@atividade), params: { atividade: { bimestre: @atividade.bimestre, data: @atividade.data, descricao: @atividade.descricao, titulo: @atividade.titulo } }
