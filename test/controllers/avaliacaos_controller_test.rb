...
class AvaliacaosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create avaliacao" do
    assert_difference('Avaliacao.count') do
      post avaliacaos_url, params: { avaliacao: { observacoes: @avaliacao.observacoes, pontos: @avaliacao.pontos } }
    end
  ...
  test "should update avaliacao" do
    patch avaliacao_url(@avaliacao), params: { avaliacao: { observacoes: @avaliacao.observacoes, pontos: @avaliacao.pontos } }
